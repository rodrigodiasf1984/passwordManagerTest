...
function Intructions() {
  const textWithDoubleQuotes =
    ' En esta pantalla el usuario que entra a la aplicación debe entender que está contratando. Deberias darle la bienvenida alproducto "Cuenta Corriente OpenClose" y explicarle que vas ademandarle sus datos en los siguientes pasos. Es una pantalla conuna explicación, nombre del producto y botones de wizard de avanzar.';
  return (
    <div className="Intructions">
      <main className="Intructions-content">
        <h1>
          Bienvenid@ al test de{' '}
          <img
            src={OpenbankLogo}
            className="Intructions-header-logo"
            alt="openbank-logo"
          />
        </h1>
        <h3>Objetivo </h3>
        ...
        <p>
          ...
          un wizard de 3 pasos en los que un usuario reciba información de que
          está a punto de crear una contraseña nueva, un formulario donde se le
          pidan una serie de datos para la creación de la contraseña y una
