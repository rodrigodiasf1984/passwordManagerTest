        ...
        <Box className="content">
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <Typography variant="h4" paddingTop={3} paddingBottom={3}>
              ...
              electrónicas. No podrás recuperar tu contraseña, asi que
              recuérdela bien.
            </Typography>
            ...
            <Typography variant="h4" paddingTop={3}>
              ...
              móvil, ele número de serie de alguno de tus dispositvos o
              cualquier información que necessites tener en lugar seguro.
            </Typography>
          </Box>
          <Box
            sx={{
